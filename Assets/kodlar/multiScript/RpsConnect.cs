...
public class RpsConnect : PunBehaviour
{
    ...
    public GameObject karakter, loginPanel,gamePanel,SinirBar,GostergeBar;
    ...
    void Start()
    {
        ...
        SinirBar.SetActive(false);
        GostergeBar.SetActive(false);
    ...
    void Update()
    {
        if (PhotonNetwork.inRoom)
        {
            if (PhotonNetwork.room.PlayerCount == 2)
            {
                ...
                SinirBar.SetActive(true);
                GostergeBar.SetActive(true);
